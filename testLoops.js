...
/*for (let guitar = 1; guitar <= 10; guitar++) {
  console.log("I have " + guitar + " guitars in my room.");
}*/
...
console.log("This is the object", guitar);

let series = "";
for (let newName in guitar) {
  console.log("this is the variable before adding", series);
  series += guitar[newName] + " ";
  console.log(" This is the variable after", series);
}
console.log("I have a" + series + "guitar in my room!");

// for of

const names = ["Daniel", "Matthew", "Wesson", "Michael"];

let text = " ";
for (let fName of names) {
  text += fName;
  console.log("This is".fName, "nice to meet you");
}
